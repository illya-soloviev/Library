...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._changeActiveDot = function (dots, slideIndex) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._calcScroll = function () {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (createdByJS) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(modal).fadeIn(500);
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._in = function (elem, disp) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._out = function (elem) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.get = async (url, answerDataType = 'json') => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.post = async (url, data, answerDataType = 'text') => {
  let res = await fetch(url, {
    method: 'POST',
    body: data
  });
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().post('https://jsonplaceholder.typicode.com/posts', data, 'json').then(res => console.log(res));
})();
